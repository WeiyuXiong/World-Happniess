...
Compared with African countries, "Logged GDP per capita", “Freedom to make life choice” and “Social support”  have stronger linear relationships in non-African countries.

The rest of the World, corruption is an important issue  that can significantly reduce happiness. In Africa, this  variable is less significant.

The shortage is that there are fewer data points for Africa, and a number of potential outliers.
