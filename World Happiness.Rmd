...
In question 1, by fitting the full model for six variables (critical factors) and comparing correlation between them, we found the “Freedom to make life choice” and “Social support” are most significant and also has the relatively high correlation with response variable “Ladder score”. Hence, we chose those two variables (the residuals all have mean zero), “Social support” and “Freedom to make life choices” to fit our model.

In question 2, we discuss the difference between Africa and other countries. There are moderately strong positive linear relationships between “Ladder score” and “Social support”. Furthermore, the linear relationships between “Ladder score” and “Social support” in the most non-African countries is stronger than that in African countries. Similarly, there are moderately strong positive linear relationships between “Ladder score” and “Freedom to make life choice” and non-African countries have higher “Freedom to make life choice” compared with African countries.
